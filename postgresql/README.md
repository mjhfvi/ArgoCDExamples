<!--- app-name: PostgreSQL -->
## build postgresql with arcgcd
# add persistent-volume-claim
kubectl -f postgres-persistent-volume-nfs.yaml apply
kubectl -f postgres-persistent-volume-claim.yaml apply

# Open Service Port
kubectl -f postgres-service.yaml apply

# argocd config file for postgresql
argocd-postgresql.yaml

# postgresql value file
values-postgresql.yaml

# run command
argocd app create postgresql -f argocd-postgresql.yaml --values values-postgresql.yaml

## Remove argocd app
argocd app delete postgresql

dbuser
12345
mydb

kubectl -n postgresql get secret postgresql -o jsonpath="{.data.password}" | base64 -d


## argocd app create postgresql -f argocd-postgresql.yaml --values-literal-file values-postgresql.yaml ## LOCAL FILE
## argocd app create postgresql -f argocd-postgresql.yaml --values values-postgresql.yaml ## FILE IN REPO
## argocd app delete postgresql
